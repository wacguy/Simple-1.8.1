...
programs/samtools-1.5/samtools view -bSh output/$wt.sam > output/$wt.bam
wait
...
programs/samtools-1.5/samtools fixmate output/$mut.bam output/$mut.fix.bam &
programs/samtools-1.5/samtools fixmate output/$wt.bam output/$wt.fix.bam
wait

#sort by coordinates
programs/samtools-1.5/samtools sort -o output/$mut.sort.bam output/$mut.fix.bam &
